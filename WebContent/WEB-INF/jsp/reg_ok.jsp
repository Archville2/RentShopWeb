...
<fmt:message bundle="${loc}" key="locale.main_button" var="main_button" />
</head>
<body>
	...
	<form action="Controller" method="post">
		<table width="100%" height="100">
			<tr align="center" valign="bottom">
				<td>Клиент успешно зарегистрирован<br><br> 
				<input type="hidden" name="command" value="show_main_page" /> 
				<input class="new" type="submit" value="${main_button}" style="width: 150Px">
				</td>
			</tr>
		</table>
	</form>
